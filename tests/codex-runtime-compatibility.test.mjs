...
test("compatibility contract freezes exact capability manifests and RPC allowlists", () => {
  ...
  assert.deepEqual(CODEX_FOLLOW_UP_TOOL_MANIFESTS.plannerNamespace, ["read", "preview", "apply", "importRecipe", "importApprovedWeek"]);
...
test("observed capability inspection requires exact ordered arrays and dependent results", () => {
  ...
  assert.deepEqual(result.plannerNamespaceMembers, ["read", "preview", "apply", "importRecipe", "importApprovedWeek"]);
